...
\begin{itemize}
	\item{11878 (C17):}{Two sets of PSA \texttt{ACQ/IMAGE}s, Target+Lamp Time-Tag images, \& G230L Spectra}
	\item{12399 (C18):}{Two sets of PSA \texttt{ACQ/IMAGE}s, One set of Target+Lamp Time-Tag images (427W3), one G230L Spectrum (427W3)}
	\item{12781 (C19):}{Two sets of PSA \texttt{ACQ/IMAGE}s}
	\item{13171 (C20):}{Two sets of PSA \texttt{ACQ/IMAGE}s}
	\item{13616 (C21):}{Two sets of PSA \texttt{ACQ/IMAGE}s}
	\item{14035 (C22):}{Two sets of PSA \texttt{ACQ/IMAGE}s}
	\item{14452 (C23):}{Two sets of PSA \texttt{ACQ/IMAGE}s,  with Lamp-Only Time-Tag images after each \texttt{ACQ/IMAGE}}
\end{itemize}
...
\vspace{1.3cm}
\centering
\includegraphics[width=\textwidth]{png/C24_14857_FP.png}
...
\begin{figure}
\noindent\includegraphics*[width=0.795\linewidth]{eps/epsHEFP13526.eps}
\caption{Cycle 21 PtNe Lamp `Family Portrait'' \ref{fig:FG21}}
\end{figure}

\begin{figure}
\noindent\includegraphics*[width=0.795\linewidth]{eps/epsHEFP13523.eps}
\caption{Cycle~§21 PtNe Lamp `Family Portrait'' \ref{fig:FG21}}
\end{figure}

\begin{figure}
\noindent\includegraphics*[width=0.795\linewidth]{eps/epsHEFP13972.eps}
\caption{Cycle~22 PtNe Lamp `Family Portrait'' \ref{fig:FG22}}
\end{figure}
\begin{figure}
\noindent\includegraphics*[width=0.795\linewidth]{eps/epsHEFP14440.eps}
\caption{Cycle~23 PtNe Lamp `Family Portrait'' \ref{fig:FG23v1}}
\end{figure}

\begin{center}
\begin{figure}
\noindent\includegraphics*[width=0.795\linewidth]{eps/epsHEFP14857.eps}
...
\tablecolumns{4}
\tablewidth{0 pt}
\tablecaption{\texttt{ACQ/PEAKXD} WCA-to-PSA offsets \label{table:soffsets}}
...
\hline
\enddata
\tablenote{Divide by 100 \textsc{pcta_} determines scaling factor. FUV are "negative"}
\end{table}
