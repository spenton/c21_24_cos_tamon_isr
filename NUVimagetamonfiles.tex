...
\enddata
%\end{center}
\tablenotetext{c}{For the \plampone{} lamp, the three current settings are LOW (6mA), MED (10mA) and HIGH (18mA). For the \plamptwo{} lamp, the current settings are LOW (3mA), MED (10mA) and HIGH (14mA).}
\tablenotetext{t}{TT = TIME-TAG.}
\tablecomments{Exposures listed as \textsc{EXPTYPE}=EXT/SCI contain coeval target and PtNe lamp (\plampone{} or \plamptwo{}) images taken in time-tag (\textsc{OBSTYPE}=TT) mode.
