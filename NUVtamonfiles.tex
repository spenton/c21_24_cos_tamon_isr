...
\tablehead{
\colhead{ROOTNAME}&\colhead{PROP}&\colhead{TARGNAME}&\colhead{OBS}&\colhead{OBS}&\colhead{EXP}&
\colhead{EXPTIME}&\colhead{LAMP}&\colhead{CEN}&\colhead{FP}&\colhead{APER}&
...
\colhead{(s)}&\colhead{USED}&\colhead{WAVE}&\colhead{POS}&\colhead{TURE}&
...
\hline
\enddata
\tablenotetext{All spectroscopic exposures were taken with the PSA at \texttt{FP-POS}=3.}
