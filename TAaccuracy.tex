% $Id: TAaccuracy.tex,v 1.3 2018/03/30 15:20:58 penton Exp $
...
\tablehead{\colhead{COS Grating} & \colhead{Total AD Error Budget} & \colhead{AD TA Requirement\tablenotemark{a}} & \colhead{XD TA Requirement\tablenotemark{x}}\\
}
\startdata
	\hline
	\multicolumn{4}{c}{NUV}\\
