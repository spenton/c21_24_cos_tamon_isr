...
\tablehead{\colhead{\textit{OPT\_ELEM}} & \colhead{Total AD Error Budget} & \colhead{AD TA Requirement\tablenotemark{a}} & \colhead{XD TA Requirement~(goal)~\tablenotemark{b}}\\
...
\tablenotetext{b}{The XD TA centering requirement is 0.3\arcsec (to avoid vignetting), but our 1$\sigma$ goal is 0.1\arcsec (to maximize spectral extraction accuracy).}
\end{deluxetable}
