...
%\vspace{-0.3cm}
The NUV spectroscopic TA subarrays for the \tacq{SEARCH} and \texttt{PEAKD} phases are identical, and are given in Table~\ref{tab:NUVspSUBSsad}.
...
\centering
	\begin{threeparttable}[tbc]
		\caption{NUV Spectroscopic \tacq{SEARCH} and \texttt{PEAKD} Target Subarrays\tnote{1}}
		...
		\begin{tablenotes}[para]
			...
			\item [2] Installed by HST commanding on 2009.200 (\pr{63095}).
		   \end{tablenotes}
...
\centering
	\begin{threeparttable}[tbc]
		\caption{NUV \tacq{PEAKXD} Subarray ``XC''s\tnote{1}}
		...
		\footnotesize
			\begin{tablenotes}
				\item[1] XC = X-Corner. For all NUV \tacq{PEAKXD} TA subarrays: YC=0, YS=1024, and XS=81; where S=Size. Updated on July 19, 2009 (2009.200) with \pr{63095}. Some early calibration observations used slightly different values.
			\end{tablenotes}
