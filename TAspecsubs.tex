...
\centering
	\begin{threeparttable}[tbc]
		\caption[NUV Spectroscopic \tacq{SEARCH} and \tacq{PEAKD} Subarrays\tnote{1}]{NUV Spectroscopic \tacq{SEARCH} and \tacq{PEAKD} Subarrays}
		...
		\begin{tablenotes}[para]
			\item [1] NUV \tacq{SEARCH} and \tacq{PEAKD} external target (SA) subarrays.
			 NUV \tacq{PEAKXD} lamp and SA subarrays are given in \ref{tab:NUVspSUBSxd}.
