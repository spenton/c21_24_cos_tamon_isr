...
\item \textit{EXPTYPE} gives the exposure type, which is either \tacq{IMAGE} or \extsci. \extsci{} images using \textit{APERTURE}=PSA allow coeval target and lamp images for
...
For the exposures in this ISR, $-91\leq \textit{LOMFSTP} \leq-86 $. For all exposures in this ISR, OSM1 reported the nominal \tacq{IMAGE} position of \textit{LOM1STP}; OSM2
