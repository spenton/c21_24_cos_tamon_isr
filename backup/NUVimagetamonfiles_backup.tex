...
\tablehead{
\colhead{ROOTNAME}&\colhead{PROP}&\colhead{TARGNAME}&\colhead{OBS}&\colhead{EXP}&
\colhead{EXPTIME}&\colhead{LAMP}&\colhead{LAMP}&\colhead{APER}&
\colhead{APER}&\colhead{APER}&\colhead{OPT}&\colhead{DATE}\\
\colhead{}&\colhead{ID}&\colhead{}&\colhead{MODE}&\colhead{TYPE}&
\colhead{(s)}&\colhead{USED}&\colhead{Current}&\colhead{TURE}&
\colhead{XPOS}&\colhead{YPOS}&\colhead{ELEM}&\colhead{OBS}\\
}
\startdata
