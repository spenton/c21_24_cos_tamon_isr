...
\colhead{PID} & \colhead{\textit{ROOTNAME}} & \colhead{\textit{APERTURE}} & \colhead{MIRROR} & \multicolumn{1}{|r}{XC} & \colhead{YC} & \colhead{XS} & \colhead{YS} & \colhead{XC} & \colhead{YC} & \colhead{XS} & \colhead{YS} & \colhead{}
}
\startdata
\hline
