% RCS_ID: $Id: cos_tamon_isr2018_v0.30.tex,v 1.1 2018/08/13 12:30:50 spenton Exp $
...
\newcommand{\acq}[1]{\texttt{ACQ/#1}}
\newcommand{\extsci}{\texttt{EXT/SCI}}
...
Sonnentrucker, P., et. al., 2016, COS ISR 2016-03, ``Summary of the COS Cycle 22 Calibration Program'' (\pid{13972}) \\
