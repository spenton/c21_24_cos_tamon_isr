...
In 2014--5, several ``hot-spots'' appeared during solar maximum. On April 20, 2015 (2015.110) with \pr{80571}, the FUV LP3 subarrays were adjusted to avoid these hot-spots.
...
\enddata
\tablenotetext{a}{These values were updated on 2009.201 (July 20, 2009) with \pr{63095}, some very early COS calibration and ERO datasets used slightly different TA subarrays.}
...
\bottomrule
\enddata
\tablenotetext{a}{Updated on 2009.201 (July 20, 2009) with \pr{63095}, some very early COS calibration and ERO datasets used slightly different TA subarrays.}
...
For further details see the C18 COS Instrument Handbook (Dixon et al., 2010) (\pr{64041} and \pr{64659}.}
\end{deluxetable}
...
TAs was deprecated on April 8, 2011 (2011.098) with \pr{67985}. FUVB is still used for \tacq{SEARCH} and \tacq{PEAKD} TA exposures.}
\tablenotetext{d}{Updated for LP3 operations on Aug. 26, 2014 (2014.238) with \pr{78747}.}
\tablenotetext{e}{Updated for post ``Hot-Spot'' LP3 TA operations on April 20, 2015 (2015.110) with \pr{80571}.}
\tablenotetext{f}{Updated for LP4 operations on Feb. 20, 2017 (2017.051) with \pr{86945}. At LP4, both FUVA and FUVB are supported for all \tacq{PEAKXD} (\textit{NUM\_POS$>1$}) TA exposures. These subarrays also avoid the FUVB ``Hot-Spot''.}
\tablenotetext{g}{Starting with C18, the C1230 \textit{CENWAVE} was replaced with C1280 due to first-order light issues.
For further details see the C18 COS Instrument Handbook (Dixon et al., 2010) (\pr{64041} and \pr{64659}.}
\end{deluxetable}
...
LP3 FUVB TA subarrays were adjusted on April 20, 2015 (2015.110)\footnote{See \pr{80571} for futher details.}.
