...
\tablecaption{FGS-to-SI Program Initial Pointing Determinations\label{tab:activesiaf}}
\tabletypesize{\footnotesize}
\tablewidth{0pt}
\tablecolumns{4}
\tablehead{
\colhead{\texttt{APERTURE}} & \colhead{YEAR.DAY} &  \colhead{V2} & \colhead{V3}\\
\colhead{} & \colhead{Activated} &  \colhead{(\arcsec)} & \colhead{(\arcsec)}
}
\startdata
\hline
