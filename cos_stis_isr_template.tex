...
{\bf Instrument Science Report COS(or STIS) YYYY-XX(v1)}
...
\item ...
\item ...
\item Change History (page \pageref{sec:History})
\item References (page \pageref{sec:References})
\item Appendices (page \pageref{sec:Appendix})
\end{itemize}
%%%%%%%%
%Body
%%%%%%%%
...
\vspace{-0.3cm}
\ssection{Section Title }
\vspace{-0.3cm}
\ssubsection{Sub Section}
...
\lhead{}
\rhead{}
\cfoot{\rm {\hspace{-1.9cm} Instrument Science Report COS(or STIS) YYYY-XX(v1) Page \thepage}}
...
\ssectionstar{Change History for COS(or STIS) ISR YYYY-XX}\label{sec:History}
\vspace{-0.3cm}
%Put publication date
Version 1: DD Month YYYY- Original Document
%%%%%%%%
%References
%%%%%%%%
\vspace{-0.3cm}
...
\noindent
Authors, year, COS Instrument Science Report YYYY-XX
\\
Author, year, journal, edition, page
