...
\tablehead{
\colhead{\textit{ROOTNAME}}&\colhead{PROP}&\colhead{TARGNAME}&
...
\colhead{}&\colhead{ID}&\colhead{}&\colhead{(s)}&\colhead{USED}&\colhead{}&
...
\hline
\enddata
\tablecomments{All exposures were taken with the PSA at \texttt{FP-POS=3}. All exposures executed at the expected aperture positions (\texttt{APERXPOS} \& \texttt{APERYPOS}).}
\end{deluxetable}
