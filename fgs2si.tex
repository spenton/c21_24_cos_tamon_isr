...
The COS portion of each program begins with a PSA$\times$MIRA \tacq{IMAGE} on a target which should be approximately centered due to observations with other instruments earlier in the visit.
